   ...
   <p><h1>Lieu :</h1></p><BR/>
	<form action="index.php?uc=lieux&action=confirmModifLieux&num=<?php echo $num ;?>" method="post">
		...
		<tbody>
			...
			<tr><td>Code postal</td><td><input type="number" step="1" min="10000" max="99999" name="TCodepostal" value="<?php echo $unLieu['CODEPOSTALHEBER'];?>"/></td></tr>	
			<tr><td>Cout </td><td><input type="number" step="0.01" name="TCout" value="<?php echo $unLieu['COUTHEBER'];?>"/></td></tr>	
			<tr><td>Capacite</td><td><input type="number" step="1" name="TCapacite" value="<?php echo $unLieu['CAPACITEHEBER'];?>"/></td></tr>			
		</tbody>
		</table>
