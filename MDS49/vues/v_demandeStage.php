...
<p>
    ...
    <table width="500">
		<tbody>
		    ...
		    <option name="H">Masculin</option>
		    <option name="F">Féminin</option>
			</select></td></tr>
	...
	<table width="500">
		<tbody>
			...
			</td><td><input type="radio" name="membreBureau" name="O" id="O" checked="checked" /> <label for="oui">Oui</label>
			<input type="radio" name="membreBureau" name="N" id="N" /> <label for="non">Non</label></td></tr>
	...
	<table width="300">
		<tbody>
			<tr><td>Votre parrain : </td><td><input type="text" name="parrainTuteur" /></td></tr>
