...
<p>
    ...
    <table width="500">
		<tbody>
		    ...
		    <tr><td>Téléphone : </td><td><input type="number" step="1" min="0" max="9999999999" id="telephone" name="telephone"/></td></tr>
		    <tr><td>E-mail : </td><td><input type="email" id="email" name="email"/></td></tr>
	...
	<table width="350">
		<tbody>
			...
			<tr><td>Mail : </td><td><input type="email" id="nomTuteur" name="mailTuteur" /></td></tr>
		</tbody>
	</table>
<br/><br/><br/>
