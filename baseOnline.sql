...
CREATE TABLE IF NOT EXISTS TUTEUR
 (
   IDTUTEUR INTEGER NOT NULL AUTO_INCREMENT ,
...
CREATE TABLE IF NOT EXISTS EXPEASSOS
 (
   IDEXPE INTEGER NOT NULL AUTO_INCREMENT ,
...
CREATE TABLE IF NOT EXISTS COMPETENCE
 (
   IDSPE INTEGER NOT NULL AUTO_INCREMENT  ,
...
CREATE TABLE IF NOT EXISTS JURY
 (
   IDJURY INTEGER NOT NULL AUTO_INCREMENT 
   , PRIMARY KEY (IDJURY) 
 ) 
 ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS INTERVENANT
 (
   IDINTERVENANT INTEGER NOT NULL AUTO_INCREMENT ,
...
CREATE TABLE IF NOT EXISTS LIEUHEBERGEMENT
 (
   IDHEBERGEMENT INTEGER NOT NULL AUTO_INCREMENT ,
...
CREATE TABLE IF NOT EXISTS COMPTE
 (
   MAILCOMPTE VARCHAR(64) NOT NULL  ,
   MDPMD5 VARCHAR(32) NOT NULL  ,
   PRIMARY KEY (MAILCOMPTE)
 ) 
 ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS INSCRITS
 (
   IDINSCRIT INTEGER NOT NULL AUTO_INCREMENT ,
